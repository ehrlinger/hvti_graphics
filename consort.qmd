...
`hv_consort()`, from hvtiPlotR [@R-hvtiPlotR], builds a CONSORT-style
patient-flow diagram via a multi-step
...
result. The diagram is drawn by the `consort` package [@R-consort] (grid graphics), so it
