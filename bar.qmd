...
`hv_eda()`, from hvtiPlotR [@R-hvtiPlotR], drives exploratory data analysis of
any variable against a reference time axis. `eda_classify_var()` detects whether a column is continuous,
